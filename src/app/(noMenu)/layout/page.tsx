"use client";
import { MenuSidebar } from "@/components/main/MainSidebar";
...
function fakeItems(count: number) {
	const items: string[] = [];
...
function LayoutA() {
	return (
		<div className="h-screen flex flex-col bg-red-500">
			<div className="h-14 w-full bg-gray-700 flex-none">HEADER</div>
			<div className="flex flex-row">
				{/* <div className="flex-none h-screen w-64 bg-blue-700">SIDE</div> */}
				<div className="h-full w-full p-2 bg-green-700">
					MAIN
					<div className="bg-yellow-400 h-full max-h-screen overflow-y-auto p-4 flex flex-col items-center">
						<div className="h-full overflow-y-auto w-full space-y-2">
							ITEMS
							<div className="bg-gray-950 w-full h-20 rounded-xl text-white inline-flex items-center justify-center">
								01
							</div>
							<div className="bg-gray-950 w-full h-20 rounded-xl text-white inline-flex items-center justify-center">
								02
...
function LayoutB() {
	...
	return (
		<div className="flex flex-col gap-1 h-screen w-full bg-red-500 p-2 max-h-screen">
			{/* <div className="h-14 w-full flex-none bg-gray-700">HEADER</div> */}
			<Header />
			<div className="flex h-full max-h-screen bg-blue-700 p-2 overflow-auto">
				{/* <div className="bg-zinc-800 w-64 text-stone-400">ASIDE</div> */}
				<Aside />
				<div className="flex w-full h-full max-h-screen flex-col bg-pink-700 p-2">
					MAIN
					<div className="flex h-full max-h-screen flex-col items-center gap-1 overflow-y-auto bg-yellow-400 p-2">
						{/* <div className="h-10 w-full rounded-lg bg-green-600 p-1">
							<button
								onClick={() => {
									if (items === 0) {
										setItems(15);
